...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_Drone_t, stringdata0) + ofs), len 
static const qt_meta_stringdata_Drone_t qt_meta_stringdata_Drone = {
    {
QT_MOC_LITERAL(0, 5) // "Drone"
...
const QMetaObject Drone::staticMetaObject = { {
    ...
    qt_meta_stringdata_Drone.offsetsAndSize,
    qt_meta_data_Drone,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_Drone_t
